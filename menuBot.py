...
# -----------------------------------------------------------------------
m_main2 = Menu("Главное меню", buttons=["Коты", "Игры", "ДЗ", "Фильм", "Музыка", "Помощь"])
m_games = Menu("Игры", buttons=["Игра КНБ", "Игра КНБ-MP", "Игра в 21", "Выход"], module="botGames", parent=m_main2)
...
m_DZ = Menu("ДЗ", buttons=["Задание-1", "Задание-2", "Задание-3", "Задание-4", "Задание-5", "Задание-6", "Задание-7", "Задание-8", "Выход"], parent=m_main2, module="DZ")
m_cats = Menu("Коты", buttons=["Котик для хорошего настроения)", "Факты о котиках", "Породы",  "Выход"], parent=m_main2, module="cats")
m_film = Menu("Фильм", buttons=["Прислать фильм", "Билеты на сегодня", "Выход"], parent=m_main2, module="film")
m_music = Menu("Музыка", buttons=["Ssshhhiiittt!!!", "Нервы", "Кис-Кис", "Выход"], parent=m_main2)
